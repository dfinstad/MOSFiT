...
class BNSEjectaGW(Energetic):
    ...
    def process(self, mass1=None, mass2=None, disk_frac=None, Mtov=None,
                ...
                radius1=None, radius2=None, radius16=None,
                v_ejecta_red=None, v_ejecta_blue=None,
                **kwargs):
        """Process module."""
        ckm = C_CGS / KM_CGS
        ...
        # NOTE this will be an overly simplified 2-component model for the kilonova,
        # where "red" is disk ejecta, and "blue" is dynamical ejecta
        ...
        # mass-averaged ejecta velocity from Nedora+ 2022
        ...
        vejecta_mean = (vejecta_red*mejecta_red +
                vejecta_blue*mejecta_blue) / (mejecta_red + mejecta_blue)

        kappa_mean = (self._kappa_red*mejecta_red +
                self._kappa_blue*mejecta_blue) / (mejecta_red + mejecta_blue)

        #return {self.key('mejecta_blue'): mejecta_blue,
        #        self.key('mejecta_red'): mejecta_red,
        #        self.key('mejecta_purple'): Mejdisk,
        #        self.key('mejecta_dyn'): Mejdyn,
        #        self.key('mejecta_tot'): Mejdyn + Mejdisk,
        #        self.key('vejecta_blue'): vejecta_blue,
        #        self.key('vejecta_red'): vejecta_red,
        #        self.key('vejecta_purple'): vdisk * ckm,
        #        self.key('vejecta_mean'): vejecta_mean,
        #        self.key('kappa_purple'): 3.0,
