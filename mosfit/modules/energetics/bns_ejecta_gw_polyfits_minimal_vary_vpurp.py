...
class BNSEjectaGW(Energetic):
    ...
    def process(self, mass1=None, mass2=None, disk_frac=None, Mtov=None,
                ...
                radius1=None, radius2=None, radius16=None, f_ejecta_red=None,
                v_ejecta_red=None, v_ejecta_blue=None, v_ejecta_purple=None,
                **kwargs):
        """Process module."""
        ckm = C_CGS / KM_CGS
        ...
        # ejecta quantities for MINIMAL model
        ...
        vejecta_purple = v_ejecta_purple * ckm #vdisk * ckm
