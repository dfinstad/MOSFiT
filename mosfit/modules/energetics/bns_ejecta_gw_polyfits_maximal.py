...
class BNSEjectaGW(Energetic):
    ...
    def process(self, mass1=None, mass2=None, disk_frac=None, Mtov=None,
                ...
                errvdyn=None, errvdisk=None, radius1=None, radius2=None,
                radius16=None, v_ejecta_red=None,
                **kwargs):
        """Process module."""
        ckm = C_CGS / KM_CGS
        ...
        mejdyn_tot = mejecta_blue + mejecta_red
        ...
        # distribute velocity according to mass
        v_ejecta_blue = (vejecta * mejdyn_tot - mejecta_red * v_ejecta_red) / mejecta_blue
        # convert to km/s
        ...
        return {self.key('mejecta_blue'): mejecta_blue,
                ...
                self.key('mejecta_tot'): mejdyn_tot + mejecta_purple,
